		...
		<div className="mt-16 rounded-lg border border-border/30 bg-muted/30">
			...
			<div className="p-5">
				<p className="text-xs leading-relaxed text-muted-foreground">
					Neural DSP®, Quad Cortex®, and related trademarks are registered
					trademarks of Neural DSP Technologies Oy. This extension is not
					affiliated with, endorsed by, or sponsored by Neural DSP Technologies
					Oy.
				</p>
			</div>
		</div>
